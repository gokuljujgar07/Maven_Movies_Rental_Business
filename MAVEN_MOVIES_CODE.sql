...
SELECT INV.STORE_ID,F.RATING,COUNT(RATING) AS TOTAL_FILMS
...
SELECT F.TITLE,C.NAME AS CATEGORY_MOVIES,LANG.NAME AS MOVIES_LANGUAGE
...
SELECT F.TITLE,COUNT(ACTOR_ID) AS NUMBER_OF_ACTOR
FROM FILM AS F
...
SELECT FIRST_NAME,LAST_NAME, "STAFF" AS DESTINATION
FROM STAFF
UNION
SELECT FIRST_NAME,LAST_NAME, "ADVISORS" AS DESTINATION
FROM ADVISOR
